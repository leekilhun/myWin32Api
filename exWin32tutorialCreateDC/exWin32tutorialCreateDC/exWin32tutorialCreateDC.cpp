// exWin32tutorialCreateDC.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "pch.h"
#include "framework.h"
#include "exWin32tutorialCreateDC.h"
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_exWin32tutorialCreateDC, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_exWin32tutorialCreateDC));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_exWin32tutorialCreateDC));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = 0;//MAKEINTRESOURCEW(IDC_exWin32tutorialCreateDC);
